...
Clusterize.prototype = {
  ...
  generate: function (rows) {
    ...
    var items_start = isNaN(Math.max((opts.rows_in_cluster - opts.rows_in_block) * this.getClusterNum(rows), 0)) ? 0 : Math.max((opts.rows_in_cluster - opts.rows_in_block) * this.getClusterNum(rows), 0),
